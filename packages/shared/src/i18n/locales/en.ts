export const en = {
  ...
  chat: {
    ...
    processSteps: 'Process ({{count}} steps)',
    todoWrite: 'Task List',
    ...
    toolAgent: 'Sub-agent',
    toolMcpSendMessage: 'Send Message',
    toolMcpListRooms: 'List Rooms',
    toolMcpListMembers: 'List Members',
    toolMcpReadMessages: 'Read Messages',
    fileAdded: 'Added',
    fileDeleted: 'Deleted',
    fileRenamed: 'Renamed',
    ...
    permissionDeny: 'Deny',
    permissionDenyWithReason: 'Deny...',
    permissionDenyReasonPlaceholder: 'Reason for denial (optional)',
    permissionTimeoutIn: 'Expires in {{seconds}}s',
    permissionAllowed: 'Allowed',
    permissionAllowedAlways: 'Always Allowed',
  ...
  agent: {
    ...
    standaloneAgents: '{{count}} standalone agents',
    standaloneAgents_one: '{{count}} standalone agent',
    gatewaysConnected: '{{count}} gateways connected',
    gatewaysConnected_one: '{{count}} gateway connected',
    capabilities: 'Capabilities',
    visibility: 'Visibility',
    visibilityPrivate: 'Private',
    visibilityDesc: 'Only you can use this agent',
    sharing: 'Sharing',
    sharingAll: 'Shared with everyone',
    sharingAllDesc: 'Any user can add this agent to rooms',
    sharingUsers: 'Shared with {{count}} users',
    sharingUsers_one: 'Shared with {{count}} user',
    sharingUsersDesc: 'Only selected users can use this agent',
    sharingManage: 'Specific users',
    searchUsers: 'Search users...',
    sharingUpdated: 'Sharing settings updated',
  ...
  agentPanel: {
    ...
    permissionLevel: 'Permission Mode',
    permissionInteractive: 'Requires approval before executing tools',
    permissionBypass: 'Auto-approve all tool executions',
    session: 'Session',
    cost: 'Cost',
  ...
  system: {
    agentOnline: '{{name}} is now online',
    agentOffline: '{{name}} went offline',
  },
}
