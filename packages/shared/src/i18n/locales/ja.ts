export const ja = {
  ...
  chat: {
    ...
    toolWebFetch: 'ウェブ取得',
    toolAgent: 'サブエージェント',
    toolMcpSendMessage: 'メッセージ送信',
    toolMcpListRooms: 'ルーム一覧',
    toolMcpListMembers: 'メンバー一覧',
    toolMcpReadMessages: 'メッセージ読み取り',
    fileAdded: '追加',
    fileDeleted: '削除',
    fileRenamed: '名前変更',
    ...
    permissionDeny: '拒否',
    permissionDenyWithReason: '拒否...',
    permissionDenyReasonPlaceholder: '拒否理由（任意）',
    permissionTimeoutIn: '{{seconds}}秒後に期限切れ',
    permissionAllowed: '許可済み',
    permissionAllowedAlways: '常に許可済み',
  ...
  agent: {
    ...
    standaloneAgents: '{{count}} 件のスタンドアロンエージェント',
    standaloneAgents_one: '{{count}} 件のスタンドアロンエージェント',
    gatewaysConnected: '{{count}} 個のゲートウェイが接続中',
    gatewaysConnected_one: '{{count}} 個のゲートウェイが接続中',
    capabilities: '機能',
    visibility: '公開範囲',
    visibilityPrivate: 'プライベート',
    visibilityDesc: '自分だけがこのエージェントを使用できます',
    sharing: '共有設定',
    sharingAll: '全員に共有',
    sharingAllDesc: 'すべてのユーザーがこのエージェントをルームに追加できます',
    sharingUsers: '{{count}} 人のユーザーと共有',
    sharingUsers_one: '{{count}} 人のユーザーと共有',
    sharingUsersDesc: '選択したユーザーのみがこのエージェントを使用できます',
    sharingManage: '特定のユーザー',
    searchUsers: 'ユーザーを検索...',
  ...
  agentPanel: {
    ...
    permissionLevel: '権限モード',
    permissionInteractive: 'ツール実行前に承認が必要',
    permissionBypass: 'すべてのツール実行を自動承認',
    session: 'セッション',
    cost: 'コスト',
    inputTokens: '入力トークン',
    outputTokens: '出力トークン',
