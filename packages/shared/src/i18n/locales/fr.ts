export const fr = {
  ...
  chat: {
    ...
    readingFileGeneric: 'Lecture du fichier',
    readingFiles: 'Lecture de {{count}} fichiers',
    routingToAgents: 'Routage vers les agents...',
    terminalUnavailable: "Le terminal n'est pas disponible sur cet appareil",
    ...
    taskUpdate: 'Mettre à jour la tâche',
    runningCommands: 'Exécution de {{count}} commandes',
    ...
    toolWebFetch: 'Récupération web',
    toolAgent: 'Sous-agent',
    toolMcpSendMessage: 'Envoyer un message',
    toolMcpListRooms: 'Lister les salons',
    toolMcpListMembers: 'Lister les membres',
    toolMcpReadMessages: 'Lire les messages',
    fileAdded: 'Ajouté',
    ...
    permissionAllowAlways: 'Toujours autoriser',
    permissionDeny: 'Refuser',
    permissionDenyWithReason: 'Refuser...',
    permissionDenyReasonPlaceholder: 'Motif du refus (facultatif)',
    permissionTimeoutIn: 'Expire dans {{seconds}}s',
    permissionAllowed: 'Autorisé',
    permissionAllowedAlways: 'Toujours autorisé',
  ...
  agent: {
    ...
    visibilityDesc: 'Vous seul pouvez utiliser cet agent',
    sharing: 'Partage',
    sharingAll: 'Partagé avec tout le monde',
    sharingAllDesc: 'Tout utilisateur peut ajouter cet agent aux salons',
    sharingUsers: 'Partagé avec {{count}} utilisateurs',
    sharingUsers_one: 'Partagé avec {{count}} utilisateur',
    sharingUsersDesc: 'Seuls les utilisateurs sélectionnés peuvent utiliser cet agent',
    sharingManage: 'Utilisateurs spécifiques',
    searchUsers: 'Rechercher des utilisateurs...',
    sharingUpdated: 'Paramètres de partage mis à jour',
  ...
  slashCommand: {
    ...
    stop: "Arrêter la génération de l'agent",
    unknownCommand: 'Commande inconnue : /{{name}}',
    platformCommands: 'Commandes de plateforme',
    agentCommands: "Commandes d'agent",
    commandSuccess: '/{{command}} exécuté avec succès',
    commandFailed: 'Échec de la commande : {{message}}',
    chatCleared: 'Chat effacé',
    stopSent: "Signal d'arrêt envoyé à {{name}}",
    noAgentFound: 'Agent introuvable : {{name}}',
    noActiveStreams: "Aucun flux d'agent actif à arrêter",
  },
  agentPanel: {
    ...
    noCommands: 'Aucune commande slash disponible',
    builtin: 'intégré',
    skill: 'compétence',
    rename: 'Renommer',
    renamed: 'Agent renommé',
    ...
    permissionLevel: 'Mode de permission',
    permissionInteractive: "Approbation requise avant l'exécution des outils",
    permissionBypass: "Approbation automatique de toutes les exécutions d'outils",
    session: 'Session',
    cost: 'Coût',
    ...
    clickToChange: 'Cliquez pour changer de modèle',
  ...
  credential: {
    ...
    rename: "Renommer l'identifiant",
    setDefault: 'Définir par défaut',
    name: "Nom de l'identifiant",
    mode: "Mode d'authentification",
    modeApi: 'Clé API',
    modeSubscription: 'Abonnement',
    apiKey: 'Clé API',
    baseUrl: 'URL de base',
    model: 'Modèle',
    default: 'Par défaut',
