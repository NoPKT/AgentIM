export const de = {
  ...
  auth: {
    ...
    oauthError: 'OAuth-Authentifizierung fehlgeschlagen. Bitte versuche es erneut.',
    linkedAccounts: 'Verknupfte Konten',
    linkAccount: 'Verknupfen',
  ...
  chat: {
    ...
    readingFileGeneric: 'Datei wird gelesen',
    readingFiles: '{{count}} Dateien werden gelesen',
    routingToAgents: 'Weiterleitung an Agenten...',
    terminalUnavailable: 'Terminal ist auf diesem Gerät nicht verfügbar',
    ...
    taskUpdate: 'Aufgabe aktualisieren',
    runningCommands: '{{count}} Befehle ausführen',
    ...
    toolSearch: 'Tool-Suche',
    toolWebSearch: 'Websuche',
    toolWebFetch: 'Web-Abruf',
    toolAgent: 'Sub-Agent',
    toolMcpSendMessage: 'Nachricht senden',
    toolMcpListRooms: 'Räume auflisten',
    toolMcpListMembers: 'Mitglieder auflisten',
    toolMcpReadMessages: 'Nachrichten lesen',
    ...
    permissionDenyWithReason: 'Ablehnen...',
    permissionDenyReasonPlaceholder: 'Ablehnungsgrund (optional)',
    permissionTimeoutIn: 'Läuft in {{seconds}}s ab',
    permissionAllowed: 'Erlaubt',
    permissionAllowedAlways: 'Immer erlaubt',
  ...
  agent: {
    ...
    standaloneAgents: '{{count}} eigenständige Agenten',
    standaloneAgents_one: '{{count}} eigenständiger Agent',
    gatewaysConnected: '{{count}} Gateways verbunden',
    gatewaysConnected_one: '{{count}} Gateway verbunden',
    capabilities: 'Fähigkeiten',
    visibility: 'Sichtbarkeit',
    visibilityPrivate: 'Privat',
    visibilityDesc: 'Nur Sie können diesen Agenten verwenden',
    sharing: 'Freigabe',
    sharingAll: 'Mit allen geteilt',
    sharingAllDesc: 'Jeder Benutzer kann diesen Agenten zu Räumen hinzufügen',
    sharingUsers: 'Mit {{count}} Benutzern geteilt',
    sharingUsers_one: 'Mit {{count}} Benutzer geteilt',
    sharingUsersDesc: 'Nur ausgewählte Benutzer können diesen Agenten verwenden',
    sharingManage: 'Bestimmte Benutzer',
    searchUsers: 'Benutzer suchen...',
    sharingUpdated: 'Freigabeeinstellungen aktualisiert',
  ...
  error: {
    ...
    validation: {
      ...
      visibilityListRequired:
        'Die Sichtbarkeitsliste darf für den ausgewählten Sichtbarkeitsmodus nicht leer sein',
  ...
  slashCommand: {
    ...
    clear: 'Chat leeren',
    stop: 'Agentengenerierung stoppen',
    unknownCommand: 'Unbekannter Befehl: /{{name}}',
    platformCommands: 'Plattformbefehle',
    agentCommands: 'Agentenbefehle',
    commandSuccess: '/{{command}} erfolgreich ausgeführt',
    commandFailed: 'Befehl fehlgeschlagen: {{message}}',
    chatCleared: 'Chat geleert',
    stopSent: 'Stoppsignal an {{name}} gesendet',
  ...
  agentPanel: {
    ...
    noCommands: 'Keine Slash-Befehle verfügbar',
    builtin: 'Eingebaut',
    skill: 'Fähigkeit',
    rename: 'Umbenennen',
    ...
    permissionLevel: 'Berechtigungsmodus',
    permissionInteractive: 'Genehmigung vor Werkzeugausführung erforderlich',
    permissionBypass: 'Alle Werkzeugausführungen automatisch genehmigen',
    session: 'Sitzung',
    cost: 'Kosten',
    ...
    clickToChange: 'Klicken, um Modell zu ändern',
  ...
  credential: {
    ...
    rename: 'Anmeldedaten umbenennen',
    setDefault: 'Als Standard festlegen',
    name: 'Name der Anmeldedaten',
    mode: 'Authentifizierungsmodus',
    modeApi: 'API-Schlüssel',
