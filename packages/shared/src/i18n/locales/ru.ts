export const ru = {
  ...
  auth: {
    ...
    oauthError: 'Ошибка аутентификации OAuth. Попробуйте снова.',
    ...
    cannotUnlinkLast: 'Нельзя отвязать последний метод аутентификации',
    totpRequired: 'Требуется двухфакторная аутентификация',
    enterTotpCode: 'Введите 6-значный код из приложения-аутентификатора',
    verifyTotp: 'Подтвердить',
    verifying: 'Проверка...',
    totpFailed: 'Неверный код. Пожалуйста, попробуйте снова.',
    useBackupCode: 'Использовать резервный код',
    backupCodePlaceholder: 'Введите резервный код',
  },
  chat: {
    rooms: 'Комнаты',
    ...
    readingFileGeneric: 'Чтение файла',
    readingFiles: 'Чтение {{count}} файлов',
    routingToAgents: 'Маршрутизация к агентам...',
    terminalUnavailable: 'Терминал недоступен на этом устройстве',
    ...
    runningCommands: 'Выполнение {{count}} команд',
    ...
    toolWebFetch: 'Загрузка веб-страницы',
    toolAgent: 'Субагент',
    toolMcpSendMessage: 'Отправить сообщение',
    toolMcpListRooms: 'Список комнат',
    toolMcpListMembers: 'Список участников',
    toolMcpReadMessages: 'Чтение сообщений',
    fileAdded: 'Добавлен',
    fileDeleted: 'Удалён',
    ...
    permissionAllowAlways: 'Всегда разрешать',
    permissionDeny: 'Отклонить',
    permissionDenyWithReason: 'Отклонить...',
    permissionDenyReasonPlaceholder: 'Причина отказа (необязательно)',
    permissionTimeoutIn: 'Истекает через {{seconds}}с',
    permissionAllowed: 'Разрешено',
    permissionAllowedAlways: 'Всегда разрешено',
    ...
    agentOffline: 'Агент сейчас офлайн',
  ...
  agent: {
    ...
    visibilityDesc: 'Только вы можете использовать этого агента',
    sharing: 'Настройки доступа',
    sharingAll: 'Доступен всем',
    sharingAllDesc: 'Любой пользователь может добавить этого агента в комнаты',
    sharingUsers: 'Доступен {{count}} пользователям',
    sharingUsers_one: 'Доступен {{count}} пользователю',
    sharingUsersDesc: 'Только выбранные пользователи могут использовать этого агента',
    sharingManage: 'Определённые пользователи',
    searchUsers: 'Поиск пользователей...',
    sharingUpdated: 'Настройки доступа обновлены',
  ...
  settings: {
    ...
    twoFactorAuthDesc: 'Добавьте дополнительный уровень безопасности к вашему аккаунту',
    enable2fa: 'Включить 2FA',
    disable2fa: 'Отключить 2FA',
    scanQrCode: 'Отсканируйте этот QR-код с помощью приложения-аутентификатора',
    orEnterManually: 'Или введите этот код вручную',
    ...
    backupCodesSaved: 'Я сохранил эти коды',
    twoFactorEnabled: 'Двухфакторная аутентификация включена',
    twoFactorDisabled: 'Двухфакторная аутентификация отключена',
    confirmDisable2fa: 'Введите пароль, чтобы отключить двухфакторную аутентификацию',
  },
  router: {
  ...
  error: {
    ...
    wsQueueFull:
      'Очередь сообщений заполнена. Некоторые сообщения могут быть потеряны. Пожалуйста, проверьте подключение.',
    wsProtocolMismatch:
      'Несоответствие версии протокола. Пожалуйста, обновите страницу или обновите клиент до последней версии.',
    validation: {
  ...
  ws: {
    queueFull: 'Очередь сообщений заполнена. Некоторые сообщения могут быть потеряны.',
  },
  pwa: {
  ...
  thread: {
    ...
    reply: 'Ответить в ветке',
  },
  slashCommand: {
    menu: 'Меню команд',
    help: 'Показать доступные команды',
    clear: 'Очистить чат',
    stop: 'Остановить генерацию агента',
    unknownCommand: 'Неизвестная команда: /{{name}}',
    platformCommands: 'Команды платформы',
    agentCommands: 'Команды агента',
    commandSuccess: '/{{command}} успешно выполнена',
    commandFailed: 'Ошибка команды: {{message}}',
    chatCleared: 'Чат очищен',
    stopSent: 'Сигнал остановки отправлен {{name}}',
  ...
  agentPanel: {
    ...
    noMcpServers: 'MCP-серверы не настроены',
    noCommands: 'Нет доступных слеш-команд',
    builtin: 'встроенная',
    skill: 'навык',
    ...
    permissionLevel: 'Режим разрешений',
    permissionInteractive: 'Требуется одобрение перед выполнением инструментов',
    permissionBypass: 'Автоматическое одобрение всех выполнений инструментов',
    session: 'Сессия',
    cost: 'Стоимость',
    ...
    clickToChange: 'Нажмите, чтобы сменить модель',
  ...
  serviceAgent: {
    ...
    edit: 'Редактировать сервисного агента',
    delete: 'Удалить сервисного агента',
    name: 'Имя',
    ...
    providers: {
      'openai-chat': 'OpenAI Чат',
      perplexity: 'Perplexity Поиск',
      'openai-image': 'OpenAI Генерация изображений',
      elevenlabs: 'ElevenLabs Синтез речи',
      runway: 'Runway Генерация видео',
      'stability-audio': 'Stability Аудио',
      meshy: 'Meshy Генерация 3D',
    ...
    configField: {
      ...
      similarityBoost: 'Усиление сходства',
      ...
      topology: 'Топология',
      targetPolycount: 'Целевое количество полигонов',
    },
    generatingStatus: 'Генерация... Это может занять несколько минут.',
  ...
  credential: {
    ...
    rename: 'Переименовать учётные данные',
    setDefault: 'Установить по умолчанию',
    name: 'Название учётных данных',
    mode: 'Способ аутентификации',
    modeApi: 'API-ключ',
    ...
    oauthHint:
      'Запустите процесс входа OAuth на удалённом шлюзе. После авторизации скопируйте URL обратного вызова из браузера и вставьте его ниже.',
    oauthStart: 'Начать вход через OAuth',
    oauthStarting: 'Запуск...',
    oauthStep1: 'Шаг 1: Откройте этот URL и авторизуйте доступ',
    oauthStep2:
      'Шаг 2: После авторизации браузер перенаправит на localhost (может отображаться ошибка). Скопируйте полный URL из адресной строки и вставьте его сюда:',
    oauthComplete: 'Завершить OAuth',
    ...
    oauthAutoHint:
      'Если вы работаете на том же компьютере, что и шлюз, авторизация завершится автоматически.',
